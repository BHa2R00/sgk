...
;  (let ((p0 (vector (vsref-xmin (aref inst1 0))
;					(vsref-ymin (aref inst1 0))))
;		(p1 (vector (vsref-xmax (aref inst1 0))
;					(vsref-ymin (aref inst1 0))))
;		(p2 (vector (vsref-xmax (aref inst1 0))
;					(vsref-ymax (aref inst1 0))))
;		(p3 (vector (vsref-xmin (aref inst1 0))
;					(vsref-ymax (aref inst1 0))))
;		(inst2.w (sname-width (aref vinst 0)))
;		(inst2.h (sname-high (aref vinst 0))))
;	(setf (aref vinst 3) p3)
;	(inst vinst)))
